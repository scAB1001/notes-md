...
| **Stop container**               | `docker stop <cname> && docker rm <cname>`               | `docker stop web && docker rm web`          |
| **Remove container**             | `docker rm <cname>`                                      | `docker rmi mycontainer:1.0`                |
| **Remove image**                 | `docker rmi <image>`                                     | `docker rmi myapp:1.0`                      |
| **Pull image**                   | `docker pull <image>`                                    | `docker pull nginx:alpine`                  |
| **Push image**                   | `docker push <repo>/<image>:<tag>`                       | `docker push myrepo/myapp:1.0`              |
| **Execute in running container** | `docker exec -it <cname> <cmd>`                          | `docker exec -it web bash`                  |
| **View logs**                    | `docker logs -f <cname>`                                 | `docker logs -f web`                        |
