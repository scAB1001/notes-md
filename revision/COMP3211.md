...
| ------------------------------------- | --------------------------------------- |
| ![[mpi-message-queue-model.png\|300]] | ![[message-queuing-system-ex.png\|300]] |
...
| --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![[advanced-transient-messaging-ex.png\|150]] | `MPI_Send(buf, count, type, dest, tag, comm)`: <br>Sends a message.<br>`MPI_Recv(buf, count, type, source, tag, comm, status)`: <br>Receives a message (blocks).<br>`MPI_Isend()` / `MPI_Irecv()`: <br>Non-blocking versions for overlap of communication and computation. |
...
| ---------------------- | ------------------------------------- |
| ![[inode-ex.png\|300]] | ![[path-name-resolution-ex.png\|401]] |
...
| --------------------------------- | ----------------------------------------- |
| ![[dns-partitioning-ex.png\|400]] | ![[namespace-implementation-ex.png\|400]] |
...
| ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| ![[dns-iterative.png\|400]]                                                           | ![[recursive-ex.png\|400]]                                                                               |
| The contacted server returns the **next server** to ask. The client does the legwork. | The contacted server **forwards the query** itself, eventually returning the final answer to the client. |
