...
>**Answer:** Time = Latency + (Size/Bandwidth) = $0.1s + {80 M\text{bit} / 1000 M\text{bit}/s} = 0.1s + 0.08s = 0.18 \text{seconds}.$ Latency is the dominant factor. The bandwidth term would dominate for 10GB file.
...
*   **Structure:** Architectural Styles (layered, object-based, microservices), System Architectures (centralised, decentralised, hybrid).
...
*   **Applications:** The **Internet of Things (IoT)** and emerging **Disruptive Applications** driving system evolution.
