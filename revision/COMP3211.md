...
Next for DS where nodes are small, mobile, and often embedded in a larger system, characterised by the fact that the system *naturally blends into the user's environment*. Coined as the IoT.
...
ore requirements for a ubiquitous computing system roughly as follows: 
