...
- Here, a much better solution is to *reduce the overall communication*, for example, by moving part of the computation that is normally done at the server to the client process requesting the service. 
