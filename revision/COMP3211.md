...
| --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![[advanced-transient-messaging-ex.png\|150]] | `MPI_Send(buf, count, type, dest, tag, comm)`: Sends a message.<br>`MPI_Recv(buf, count, type, source, tag, comm, status)`: Receives a message (blocks).<br>    *   `MPI_Isend()` / `MPI_Irecv()`: Non-blocking versions for overlap of communication and computation. |
|                                               |                                                                                                                                                                                                                                                                        |
