...
They share the same interface and communicate with the same common protocol t to interact with services from other open systems, irrespective of the underlying environment:
