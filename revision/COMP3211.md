...
Unlike grid computing, which is strongly associated with high-performance computing (HPC), cloud computing is much more than just providing lots of resources.
