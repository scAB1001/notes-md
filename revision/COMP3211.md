...
3.  **Forward:** When it encounters another node, it may **forward** the message based on a chosen strategy.
...
Mobile computing shifts the design focus from stable connectivity and fixed locations to **mobility management, discovery, and tolerant routing** in the face of constant change and potential disconnection.
