...
Entropy equation: $$ log_2N^L = log_{10}N^L \div log_{10}2 =\text{total bits} $$Total entropy:$$
\begin{rcases}
  N = 95 \\
  L = 8
\end{rcases} = 8\cdot{log_{10}95 \over log_{10}2} = 8 \cdot log_2{95} = 52.56(\text{2D.P.})
$$ 
#### Example
...
  N = 10 \\
  L = 4
\end{rcases} = 4\cdot{log_{10}10 \over log_{10}2} = {4 \over log_{10}2} \ OR \ 4 \cdot log_2{10} = 13.29(\text{2D.P.})
$$
### Key Sweeper
...
# 8. DNS, ARP & Application Protocols