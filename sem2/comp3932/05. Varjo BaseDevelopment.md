...
## [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#using-the-sample-scene)Using the Sample Scene
...
## [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#sample-scene-hierarchy-overview)Sample Scene Hierarchy Overview

![SampleSceneHierarchy](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/images/sample-scene-hierarchy.png)

## [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#interactables)Interactables
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#audio-affordance-receiver-example)Audio Affordance Receiver Example
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#edge-color-affordance-theme-example)Edge Color Affordance Theme Example
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#audio-affordance-theme-example)Audio Affordance Theme Example

![AudioAffordanceTheme](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/images/audio-affordance-theme.png)

## [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#teleportation)Teleportation
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#teleportation-area)Teleportation Area
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#teleportation-anchor)Teleportation Anchor

![TeleportAnchor](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/images/teleport-anchor.png)

## [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#spatial-ui)Spatial UI
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#spatial-ui-example)Spatial UI Example

![SpatialUI](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/images/ui-setup.png)

## [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#project-configuration)Project Configuration
...
### [](https://docs.unity3d.com/Packages/com.unity.template.vr@6.1/manual/index.html#graphics-apis)Graphics APIs

The last setting you may need to adjust if you are using the Android build target is the Graphics API. By default, the VR Template uses the Vulkan graphics API for compatibility and performance reasons, including reduced build times. If you are targeting a device that does not fully support the Vulkan API, you may have to add OpenGLES3 to this list. You can do this by following these steps:
