...
#### 1.5.1 Foundational 3D Interaction & HCI Taxonomy
...
#### 1.5.2 The Psychology of Virtual Embodiment
...
#### 1.5.3 Biomechanics, Fatigue, and Ergonomics
...
#### 1.5.4 Hardware Realities: Controllers vs. Optical Tracking
...
#### 1.5.5 Multi‑Modal Interfaces and UI Compensation
...
\subsubsection{6.1.1 Participant Demographics and Flow}
\label{}
- Table of baseline characteristics.
- CONSORT flow diagram (reference to Chapter 3).


\subsubsection{6.1.2 Objective Performance Metrics}
\label{}
...
\subsubsection{6.1.3 Subjective Metrics (RTLX and SUS)}
\label{}
...
\subsubsection{6.1.4 Qualitative Feedback}
\label{}
...
\subsubsection{6.2.1 Interpretation of Results}
\label{}
...
\subsubsection{6.2.2 Limitations}
\label{}
...
\subsubsection{6.2.3 Relation to Aims and Objectives}
\label{}
