...
X_test shape: (38, 4)
k-Nearest Neighbors (y_test shape: (38,)
```
...
decision tree, $𝑝_0 = 34/110 = 0.31, 𝑝_1 = 36/110 = 0.33, 𝑝_2 = 40/110 = 0.36$.
Define the entropy S of a node as: $$
S = -\sum_{\substack{c}} {p_c} \log_2{p_c}$$For example, S for the top node is:
...
$C × (−1/C log_2 1/C) = −log_2 1/C = log_2 C$
