...
by many users and applications, and often cross multiple administrative boundaries, make them particularly vulnerable to security attacks.
boundaries, make them particularly vulnerable to security attacks.
...
cheaper than having to buy and maintain storage for each user separately.
