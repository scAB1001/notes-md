...
This component was called a transaction processing monitor (TP monitor). 
...
- Essentially, the TP monitor coordinated the commitment of subtransactions following a standard protocol known as **distributed commit**,
